...
export const ACTION_CATEGORY_COLORS = {
  // Utilise le code de la catégorie (category_id.code dans action_subcategory)
  DEP: "red", // Dépannage → rouge (bloqué)
  FAB: "blue", // Fabrication / Modification → bleu
  DOC: "blue", // Documentation / Schéma → bleu
  PREV: "green", // Préventif / Vérification → vert (OK)
  SUP: "amber", // Support / Coordination → orange (attente)
  BAT: "gray", // Bâtiment / Travaux / Aménagement → gris
};
