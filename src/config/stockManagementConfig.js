...
// Couleurs définies dans colorPalette.js → COLOR_USAGE.urgency
export const URGENCY_LEVELS = [
  { value: 'all', label: 'Toutes' },
  { value: 'high', label: 'Urgent', color: 'red', variant: 'solid' }, // error → red
  { value: 'normal', label: 'Normal', color: 'amber', variant: 'soft' }, // warning → amber
  { value: 'low', label: 'Faible', color: 'gray', variant: 'soft' }, // textSecondary → gray
];
