    ...
    const { data } = await api.get('/items/purchase_request', {
      params: {
        ...
        fields: [
          ...
          'stock_item_id.id',
          'stock_item_id.ref',
          'stock_item_id.supplier_refs.id',
          'item_label',
          'quantity',
          'unit',
          'urgency',
          ...
          'created_at',
          'intervention_id',
          'supplier_order_line_ids.id',
          'supplier_order_line_ids.supplier_order_line_id.id',
          'supplier_order_line_ids.supplier_order_line_id.is_selected',
          'supplier_order_line_ids.supplier_order_line_id.quantity',
          'supplier_order_line_ids.supplier_order_line_id.quantity_received',
          'supplier_order_line_ids.supplier_order_line_id.supplier_order_id.id',
          'supplier_order_line_ids.supplier_order_line_id.supplier_order_id.status',
          'supplier_order_line_ids.supplier_order_line_id.supplier_order_id.order_number',
        ].join(','),
        _t: Date.now(),
      },
    });
