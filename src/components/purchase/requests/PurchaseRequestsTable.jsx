 ...
 * Désormais rendu via DataTable pour mutualiser header, empty state et layout.
 */
                    ...
                    <Flex direction="column" gap="2" p="3">
                      ...
                      {isAddingSpecs && (
                        <Flex direction="column" gap="3" p="3" style={{ borderTop: "1px solid var(--gray-4)" }}>
                          ...
                          <Flex gap="2" justify="end">
                            <Button variant="soft" color="gray" onClick={() => { setAddingSpecsId(null); setSpecsFormData({ title: "", spec_text: "", isDefault: true }); }}>Annuler</Button>
                            <Button color="blue" disabled={loading} onClick={async () => {
                              if (onAddStandardSpec && specsFormData.title && specsFormData.spec_text) {
                                try {
                                  ...
                                  await new Promise((resolve) => setTimeout(resolve, 500));
                                  setSpecsFormData({ title: "", spec_text: "", isDefault: true });
                                } catch (err) {
                                  console.error("Erreur:", err);
                                }
                              }
